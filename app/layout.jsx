...
import Header1 from "@/components/common-components/header-1";
...
export default function RootLayout({ children }) {
  ...
  const hideHeader = pathname === "/update-user-data" || pathname === "/user-verification";
